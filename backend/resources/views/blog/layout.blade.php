...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ rtrim(config('app.asset_url'), '/') }}/ViaKashmir-logo-light.png">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                ...
                <a href="/" class="flex items-center min-w-[140px]">
                    <img src="{{ rtrim(config('app.asset_url'), '/') }}/ViaKashmir-logo-light.png" alt="Via Kashmir"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            <div class="flex flex-col lg:flex-row justify-between mb-24 gap-16 lg:gap-32">
                ...
                <div class="max-w-sm">
                    <div class="flex items-center">
                        <img src="{{ rtrim(config('app.asset_url'), '/') }}/ViaKashmir-logo-dark.png"
                            alt="Viakashmir" class="h-32 w-auto object-contain block">
                    </div>
                    ...
                    <div class="flex gap-4">
                        <a href="https://www.facebook.com/people/Via-Kashmir/61581764279006/" target="_blank"
                        ...
                        <a href="https://www.instagram.com/viakashmir_official/" target="_blank"
                            rel="noopener noreferrer"
                            class="w-10 h-10 rounded-full bg-white/5 border border-white/10 hover:bg-[#faa81e] flex items-center justify-center text-white/70 hover:text-[#043b36] transition-all group">
                            <svg class="w-5 h-5 transition-transform group-hover:scale-110" fill="currentColor"
                                viewBox="0 0 24 24">
                        ...
                        <a href="https://www.linkedin.com/company/via-kashmir" target="_blank"
                            rel="noopener noreferrer"
                            class="w-10 h-10 rounded-full bg-white/5 border border-white/10 hover:bg-[#faa81e] flex items-center justify-center text-white/70 hover:text-[#043b36] transition-all group">
                            <svg class="w-5 h-5 transition-transform group-hover:scale-110" fill="currentColor"
                                viewBox="0 0 24 24">
                        ...
                        <a href="https://www.youtube.com/@ViaKashmir_official" target="_blank"
                            rel="noopener noreferrer"
                            class="w-10 h-10 rounded-full bg-white/5 border border-white/10 hover:bg-[#faa81e] flex items-center justify-center text-white/70 hover:text-[#043b36] transition-all group">
                            <svg class="w-5 h-5 transition-transform group-hover:scale-110" fill="currentColor"
                                viewBox="0 0 24 24">
                        ...
                        <ul class="space-y-6">
                            <li class="flex items-start gap-3">
                                ...
                                <div class="text-white/70 text-sm">
                                    ...
                                    <a href="mailto:contact@viakashmir.com"
            ...
            <div class="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
                <p class="text-white/40 text-sm">
                    &copy; {{ date('Y') }} Via Kashmir. All rights reserved.
                </p>
