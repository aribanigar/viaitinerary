    ...
    <div className={`relative ${className} group`}>
      <div className="relative">
        <ReactDatePicker
          ...
          className={`${inputClassName || "w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all cursor-pointer font-sans appearance-none"} pr-10`}
