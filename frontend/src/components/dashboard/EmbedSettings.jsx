  ...
  return (
    <DashboardLayout>
      <div className="p-6 max-w-5xl mx-auto">
          ...
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="bg-[#e7f63c] text-white px-4 py-2 rounded-lg hover:bg-[#d4e42e] transition-all font-semibold text-sm flex items-center gap-2 whitespace-nowrap"
              >
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={handleCopy}
              className={`${
                copied ? "bg-green-500" : "bg-[#e7f63c]"
              } text-white px-4 py-2 rounded-lg hover:bg-[#d4e42e] transition-all font-semibold text-sm flex items-center gap-2`}
            >
              {copied ? (
                <>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-8 h-8 bg-[#e7f63c] text-white rounded-full flex items-center justify-center font-bold">
                1
              </div>
              <div>
        ...
        {/* Tips */}
        <div className="mt-6 bg-blue-50 border-l-4 border-[#e7f63c] rounded-lg p-6">
