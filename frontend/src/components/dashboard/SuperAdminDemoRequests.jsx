            ...
            >
              ...
              <td>
                <select
                  ...
                  className={`px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest border-none focus:ring-2 focus:ring-[#e7f63c]/20 transition-all cursor-pointer ${getStatusColor(request.status)}`}
                >
