          ...
          <div className="flex items-center gap-3">
            <div className="relative group">
              ...
              <select
                ...
                className="pl-11 pr-10 py-3 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-900 focus:ring-4 focus:ring-[#e7f63c]/5 focus:border-[#e7f63c] transition-all shadow-sm appearance-none cursor-pointer min-w-[220px]"
              >
                    ...
                    >
                      <td className="px-8 py-6">
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-12 rounded-2xl bg-[#e7f63c] flex items-center justify-center text-white font-black text-lg border-4 border-white shadow-sm shrink-0">
              ...
              <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-8">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 pb-8 border-b border-slate-50">
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="w-16 h-16 rounded-[1.5rem] bg-[#e7f63c] flex items-center justify-center text-white font-black text-2xl shadow-xl shadow-blue-500/10">
                        {(() => {
