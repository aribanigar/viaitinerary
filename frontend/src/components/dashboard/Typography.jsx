            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 font-bold focus:ring-2 focus:ring-[#e7f63c]/20 focus:border-[#e7f63c] outline-none transition-all"
                />
          ...
          <div className="mt-8 pt-8 border-t border-slate-100">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 font-bold focus:ring-2 focus:ring-[#e7f63c]/20 focus:border-[#e7f63c] outline-none transition-all resize-vertical"
              />
              <p className="text-[9px] text-slate-400 font-medium">
