          ...
          <div className="bg-white rounded-4xl border border-slate-100 shadow-sm p-8">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3.5 bg-slate-50 border-none rounded-2xl text-sm font-bold text-slate-900 focus:ring-2 focus:ring-[#e7f63c]/20 transition-all"
              />
            </div>
          </div>
              ...
              <div className="space-y-10">
                {selectedHotels.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      <select
                        className="w-full px-4 py-3.5 bg-slate-50 border-none rounded-2xl text-sm font-bold text-slate-900 focus:ring-2 focus:ring-[#e7f63c]/20 transition-all appearance-none"
                        value={item.hotel?.id || ""}
                        onChange={(e) => {
