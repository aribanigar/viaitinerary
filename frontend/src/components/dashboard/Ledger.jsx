        ...
        <div className="p-6 border-b border-slate-50 flex flex-col md:flex-row items-start md:items-center gap-3">
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 bg-slate-50 border-none rounded-xl text-sm text-slate-900 focus:ring-2 focus:ring-[#e7f63c]/20 transition-all placeholder:text-slate-300 placeholder:font-medium font-medium"
            />
          </div>
          <select
            value={statusFilter}
            onChange={(e) => setStatusFilter(e.target.value)}
            className="w-full md:w-auto px-4 py-3 rounded-xl border border-slate-200 bg-white text-sm font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#e7f63c]/20"
          >
          ...
          <button
            ...
            className="w-full md:w-auto px-6 py-3 rounded-xl bg-[#e7f63c] text-[#181c22] text-sm font-bold shadow-lg shadow-[#e7f63c]/40 hover:bg-[#d4e42e] transition-all"
          >
            Apply Filters
          </button>
        </div>
                                    ...
                                    >
                                      <div className="flex justify-between items-center mb-2">
                                        ...
                                        <button
                                          ...
                                          className="text-xs inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-[#e7f63c] text-[#181c22] font-bold"
                                        >
