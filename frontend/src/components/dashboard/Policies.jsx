      ...
      <div className="group flex items-start justify-between bg-blue-50/50 border border-blue-200 p-3 rounded-xl transition-all shadow-sm">
        ...
        <div className="flex gap-1 ml-2 mt-[-2px]">
          <button
            onClick={handleSave}
            title="Save Edit"
            className="text-white bg-[#e7f63c] hover:bg-[#d4e42e] p-1.5 rounded-lg transition-colors shrink-0 shadow-sm"
          >
        ...
        <div>
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 bg-white border border-slate-200 rounded-xl py-2.5 px-4 text-[13px] font-bold text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#e7f63c]/20 focus:border-[#e7f63c] transition-all placeholder:text-slate-400 placeholder:font-medium shadow-sm"
            />
            <button
              onClick={handleAdd}
