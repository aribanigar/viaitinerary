      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-[#e7f63c] text-[#181c22] rounded-lg hover:bg-[#d4e42e] transition-colors font-medium shadow-sm shadow-[#e7f63c]/40"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {plans.map((plan) => (
              <div
                ...
                } ${plan.recommended ? "ring-2 ring-[#e7f63c] ring-offset-2" : ""}`}
              >
                {plan.badge_label && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#e7f63c] text-[#181c22] text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest shadow-lg shadow-[#e7f63c]/40">
                    {plan.badge_label}
                  </div>
                )}
                ...
                <button
                  ...
                  className={`mt-auto w-full py-2.5 rounded-xl font-bold transition-all border-2 ${
                    plan.is_active
                      ...
                      : "border-blue-600 bg-[#e7f63c] text-[#181c22] hover:bg-[#d4e42e] shadow-sm"
                  }`}
                >
          ...
          <div className="space-y-4 text-left">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:outline-none focus:ring-4 focus:ring-[#e7f63c]/5 focus:border-[#e7f63c] transition-all text-sm font-bold text-slate-900"
                value={formData.name}
                onChange={(e) =>
              ...
              >
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-11 bg-slate-50 border border-slate-100 rounded-xl focus:outline-none focus:ring-4 focus:ring-[#e7f63c]/5 focus:border-[#e7f63c] transition-all text-sm font-bold text-slate-900"
                    value={countrySearch}
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    min="0"
                    placeholder="3000"
                    className="w-full pl-8 pr-4 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:outline-none focus:ring-4 focus:ring-[#e7f63c]/5 focus:border-[#e7f63c] transition-all text-sm font-bold text-slate-900"
            ...
            <div className="space-y-1.5">
              ...
              <div className="space-y-2">
                {(Array.isArray(formData.features)
                  ...
                  <div key={index} className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2.5 bg-slate-50 border border-slate-100 rounded-xl focus:outline-none focus:ring-4 focus:ring-[#e7f63c]/5 focus:border-[#e7f63c] transition-all text-sm font-medium text-slate-900"
                      value={feature}
                      onChange={(e) =>
                ...
                <button
                  ...
                  className="w-full py-2 bg-slate-50 border border-dashed border-slate-200 rounded-xl text-xs font-bold text-slate-400 hover:border-[#e7f63c] hover:text-blue-500 transition-all"
                >
            ...
            <div className="flex items-center gap-6 p-4 bg-slate-50 rounded-2xl border border-slate-100">
              <div className="flex items-center gap-2">
                <input
                  type="checkbox"
                  id="recommended"
                  className="w-5 h-5 text-blue-600 rounded-lg border-slate-200 focus:ring-[#e7f63c] transition-all cursor-pointer"
              ...
              <div className="p-4 bg-blue-50 rounded-2xl border border-blue-100 space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      type="date"
                      className="w-full px-4 py-3 bg-white border border-blue-100 rounded-xl focus:outline-none focus:ring-4 focus:ring-[#e7f63c]/5 focus:border-[#e7f63c] transition-all text-sm font-bold text-slate-900"
