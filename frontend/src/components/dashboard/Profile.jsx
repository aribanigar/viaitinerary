          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="flex items-center gap-6">
              <div className="relative">
                <div className="w-24 h-24 rounded-full bg-[#e7f63c] flex items-center justify-center text-white font-bold text-2xl ring-4 ring-white shadow-lg">
                  {preview ? (
                    <img
                      src={preview}
                      alt="Profile"
                ...
                <button
                  ...
                  className="absolute -bottom-2 -right-2 w-8 h-8 bg-[#e7f63c] hover:bg-[#e7f63c] text-[#181c22] rounded-full flex items-center justify-center transition-colors"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#e7f63c] focus:border-[#e7f63c]"
            ...
            <div className="flex justify-end pt-4">
              <button
                type="submit"
                disabled={loading}
                className="px-6 py-2 bg-[#e7f63c] hover:bg-[#e7f63c] text-[#181c22] rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
