          ...
          <div>
            ...
            <div className="relative group">
              <input
                ...
                onChange={handleInputChange}
                className="w-full px-4 pr-12 py-3.5 bg-slate-50 border-none rounded-2xl text-sm font-bold text-slate-900 focus:ring-2 focus:ring-[#e7f63c]/20 transition-all placeholder:text-slate-300 placeholder:font-medium"
                placeholder={
                  editingId
          ...
          <div>
            ...
            <div className="phone-input-container">
              <PhoneInput
                ...
                className="w-full"
                inputClassName="!w-full !px-4 !py-7 !bg-slate-50 !border-none !rounded-2xl !text-sm !font-bold !text-slate-900 !focus:ring-2 !focus:ring-[#e7f63c]/20 !transition-all !placeholder:text-slate-300 !placeholder:font-medium"
              />
            </div>
          </div>
        </div>
