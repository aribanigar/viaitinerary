        ...
        <div className="p-6 border-b border-slate-50 flex items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 bg-slate-50 border-none rounded-xl text-sm font-bold text-slate-900 focus:ring-2 focus:ring-[#e7f63c]/20 transition-all placeholder:text-slate-300"
              value={searchQuery}
                ...
                <td className="text-right">
                  {inquiry.assigned_to ? (
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 bg-[#e7f63c] text-[#181c22] px-4 py-2 rounded-xl text-xs font-bold hover:bg-[#d4e42e] transition-all shadow-md shadow-blue-500/10"
                    >
            ...
            <div className="p-8">
              <div className="mb-8">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full pl-4 pr-10 py-4 bg-slate-50 border-none rounded-xl text-sm font-bold text-slate-900 focus:ring-2 focus:ring-[#e7f63c]/20 transition-all appearance-none cursor-pointer"
                  >
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-4 bg-[#e7f63c] text-[#181c22] rounded-xl hover:bg-[#d4e42e] disabled:opacity-50 transition-all font-bold text-sm shadow-lg shadow-[#e7f63c]/40 flex items-center justify-center gap-2"
                >
                  {assigning ? (
