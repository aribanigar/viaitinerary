        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 bg-[#e7f63c] text-[#181c22] px-6 py-3 rounded-2xl font-bold hover:bg-[#d4e42e] transition-all text-sm w-fit shadow-lg shadow-[#e7f63c]/40"
            >
