          ...
          >
            {submitted ? (
              <div className="py-12 flex flex-col items-center justify-center text-center">
                ...
                <Link
                  to="/"
                  className="bg-[#e7f63c] hover:bg-[#d4e42e] text-white px-8 py-3 rounded-xl font-bold transition-all shadow-lg shadow-blue-500/25"
                >
                  Return to Home
                </Link>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-2.5">
                      ...
                      <input
                        ...
                        name="name"
                        type="text"
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-slate-900 placeholder:text-slate-400 focus:outline-hidden focus:ring-2 focus:ring-[#e7f63c]/20 focus:border-[#e7f63c] transition-all"
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="relative">
                      <select
                        required
                        name="agency_type"
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-slate-900 focus:outline-hidden focus:ring-2 focus:ring-[#e7f63c]/20 focus:border-[#e7f63c] transition-all appearance-none cursor-pointer"
                  ...
                  <div className="space-y-2.5">
                    ...
                    <textarea
                      required
                      name="destinations"
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-slate-900 placeholder:text-slate-400 focus:outline-hidden focus:ring-2 focus:ring-[#e7f63c]/20 focus:border-[#e7f63c] transition-all min-h-[120px] resize-none"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-slate-50 p-6 rounded-2xl border border-slate-200">
                      {automationProcesses.map((process) => (
                        ...
                        >
                          <input
                            type="checkbox"
                            className="w-5 h-5 border-slate-300 rounded-md bg-white text-blue-600 focus:ring-[#e7f63c]/20 transition-all"
                  ...
                  <motion.button
                    ...
                    type="submit"
                    disabled={loading}
                    className="w-full bg-[#e7f63c] hover:bg-[#d4e42e] disabled:bg-blue-400 disabled:cursor-not-allowed text-white font-black text-lg py-4.5 rounded-2xl flex items-center justify-center gap-3 transition-all mt-8 shadow-xl shadow-blue-600/25"
                  >
                    {loading ? (
