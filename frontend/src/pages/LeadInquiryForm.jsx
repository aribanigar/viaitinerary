                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      } rounded-lg focus:outline-none focus:ring-2 focus:ring-[#e7f63c] transition-all`}
                  ...
                  <div className="flex justify-end">
                    <button
                      type="button"
                      onClick={handleNext}
                      className="bg-[#e7f63c] text-[#181c22] px-8 py-3 rounded-full font-bold hover:opacity-90 transition-all flex items-center gap-2"
                    >
                      Next →
                    </button>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        min="0"
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#e7f63c] transition-all"
                        placeholder="50000"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={5}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#e7f63c] transition-all resize-none"
                  ...
                  <div className="flex justify-between">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="bg-[#e7f63c] text-[#181c22] px-8 py-3 rounded-full font-bold hover:opacity-90 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 shadow-sm"
                    >
                      {loading ? (
                        <>
