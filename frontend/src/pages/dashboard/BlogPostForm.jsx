        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button
                ...
                className="px-6 py-2 bg-[#e7f63c] text-[#181c22] rounded-lg hover:bg-[#d4e42e] disabled:opacity-50 transition-colors shadow-md"
                disabled={saving}
              >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#e7f63c]"
