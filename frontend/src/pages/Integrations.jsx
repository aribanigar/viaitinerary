                        ...
                        {hasMetaSheet && !isEditingMetaSheet ? (
                          ...
                          <div className="flex gap-2">
                            <input
                              ...
                              className="flex-1 px-3 py-2.5 rounded-lg bg-white border border-slate-200 text-sm font-semibold text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#e7f63c]"
                            />
                            <button
                              onClick={saveMetaSettings}
                              disabled={savingMeta}
                    ...
                    {platform.id === "meta" ? (
                      <div className="bg-slate-50 border border-slate-100 rounded-xl p-3.5 space-y-2">
                        ...
                        <input
                          ...
                          onChange={(e) => setMetaSheetUrl(e.target.value)}
                          placeholder="https://docs.google.com/spreadsheets/d/..."
                          className="w-full px-3 py-2.5 rounded-lg bg-white border border-slate-200 text-sm font-semibold text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#e7f63c]"
                        />
                        <button
                          onClick={saveMetaSettings}
                          disabled={savingMeta}
