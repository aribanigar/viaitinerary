...
// GET /api/trips/:tripId/invoice-pdf — invoice document.
export async function GET(request, { params }) {
  ...
  const buffer = await renderInvoicePdf(trip, settings);
  return new Response(buffer, {
    headers: {
      "Content-Type": "application/pdf",
      "Content-Disposition": `attachment; filename="${trip.tripId}_Invoice.pdf"`,
    },
  });
}
